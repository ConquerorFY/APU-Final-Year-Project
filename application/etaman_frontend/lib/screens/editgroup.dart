                          ...
                          decoration: InputDecoration(
                            ...
                            enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color:
                                        settings.editGroupTextFieldBorderColor,
                                    width: settings
                                        .editGroupTextFieldBorderWidth)),
                            focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color:
                                        settings.editGroupTextFieldBorderColor,
                                    width:
                                        settings.editGroupTextFieldBorderWidth +
                                            1.0)),
                          ),
                        ),
                        ...
                        onPressed: () async {
                          ...
                          if (!(_nameKey.currentState!.validate() &&
                            ...
                            if (nameResponse != null) {
                              ...
                              final nameMessage =
                                  nameResponse["data"]["message"];
                              if (nameStatus > 0) {
                                // Success message
                                // ignore: use_build_context_synchronously
                                popupService.showSuccessPopup(
                                    context,
                                    "Edit Group Name Success",
                                    nameMessage, () async {
